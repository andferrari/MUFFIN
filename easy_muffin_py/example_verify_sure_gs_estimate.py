...
DM = SNSD(mu_s=0.8,nitermax=150,nb=('db1','db2','db3','db4','db5','db6','db7','db8'),var = var, truesky=sky)
...
# easy MUFFIN
[SpectralSkyModel, cost_, snr_]=DM.main()
...
# easy MUFFIN SURE 
[SpectralSkyModel_gs, cost_gs, snr_gs, psnr_true_gs, psnr_est_gs, wmse_true_gs, wmse_est_gs, mu_s_gs]=DM.main(method='la')
